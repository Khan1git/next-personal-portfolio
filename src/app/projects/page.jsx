            ...
            <div className="projects_container">
                ...
                <div className="project_card">
                    ...
                    <div className="project_info">
                        ...
                        <a href="project_link" className="project_link">View Project</a>
                    </div>
                </div>
                ...
                <div className="project_card">
                    ...
                    <div className="project_info">
                        ...
                        <p>Generate detailed PDF reports for each student's attendance history</p>
                        <a href="project_link" className="project_link">View Project</a>
                    </div>
                </div>
                ...
                <div className="project_card">
                    ...
                    <div className="project_info">
                        <h3>Next.js Animated Website with GSAP </h3>
                        ...
                        <p>Highlights the system's features and functionality in an engaging and interactive design</p>
                        <a href="project_link" className="project_link">View Project</a>
                    </div>
                </div>
                ...
                <div className="project_card">
                    ...
                    <div className="project_info">
                        <h3>Social Media App (Facebook Clone) </h3>
                ...
                <div className="project_card">
                    ...
                    <div className="project_info">
                        ...
                        <p>A tissue-selling website designed for comfort and ease of use</p>
